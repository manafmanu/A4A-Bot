...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('𝙐𝙥𝙙𝙖𝙩𝙚𝙨', url='https://t.me/freakers_series')
            ],
            [
                InlineKeyboardButton('𝙈𝙤𝙫𝙞𝙚 𝙂𝙧𝙤𝙪𝙥', url=f"https://t.me/freakersfilmy"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('𝑺𝒆𝒕𝒊𝒆𝒔 𝑼𝒑𝒅𝒂𝒕𝒆𝒔🍃', url='https://t.me/freakers_series'),
            InlineKeyboardButton('𝑴𝒐𝒗𝒊𝒆 𝑼𝒑𝒅𝒂𝒕𝒆𝒔🍃', url='https://t.me/freakersmovie')
            ],[
            InlineKeyboardButton('𝑯𝒆𝒍𝒑🍃', callback_data='help'),
            InlineKeyboardButton('𝑨𝒅𝒐𝒖𝒕🍃', callback_data='about')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "𝘑𝘰𝘪𝘯 𝘜𝘱𝘥𝘢𝘵𝘦 𝘤𝘩𝘢𝘯𝘯𝘦𝘭🍃", url=invite_link.invite_link
                )
            ]
        ]
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ', url='https://t.me/freakersmovie') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
